...
def build_fit_null_command(
    ...
    is_remove_zeros_pheno: str = 'FALSE',
):
    ...
    saige_command_step1 += f' --isRemoveZerosinPheno={is_remove_zeros_pheno}'
    return saige_command_step1


# Run association (gene-set or single-variant)
def build_run_association_test_command(
    test_type: str,  # 'single' or 'set'
    plink_prefix: str,
    saige_output_file: str,  # .txt
    chrom: str,
    gmmat_model_path: str,  # generated by step1 (.rda)
    variance_ratio_path: str,  # generated by step1 (.txt)
    group_annotation: str = None,  # e.g., 'lof:missense'
    group_file: str = None,  # .txt
...
def saige_pipeline(
    ...
    for celltype in celltype_list:
        ...
        for gene in plink_genes:
            ...
            cmd = build_run_association_test_command(
                test_type=test_type,
